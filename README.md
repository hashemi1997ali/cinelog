...
🔗 **Website:**  
Click [here](https://cinelog-699k.onrender.com) to view the live demo.
...
1. Get your TMDB API token from [TMDB](https://www.themoviedb.org/settings/api).
2. Create a `.env` file in the root directory.
3. Add: `VITE_TMDB_API_TOKEN=your_actual_token`
